...
class JadwalSenin extends StatelessWidget {
  const JadwalSenin({super.key});
          ...
          if (state is JadwalDisplayLoaded) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return CardJadwal(
                  jam: state.jadwals[0].hariSenin[index].jam,
                  kegiatan: state.jadwals[0].hariSenin[index].kegiatan,
                  pelaksana: state.jadwals[0].hariSenin[index].pelaksana,
                  urutan: index + 1,
                );
              },
              ...
              itemCount: state.jadwals[0].hariSenin.length,
            );
          }
          return Container();
        },
