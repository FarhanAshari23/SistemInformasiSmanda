...
class JadwalRabu extends StatelessWidget {
  const JadwalRabu({super.key});
          ...
          if (state is JadwalDisplayLoaded) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return CardJadwal(
                  jam: state.jadwals[0].hariRabu[index].jam,
                  kegiatan: state.jadwals[0].hariRabu[index].kegiatan,
                  pelaksana: state.jadwals[0].hariRabu[index].pelaksana,
                  urutan: index + 1,
                );
              },
              ...
              itemCount: state.jadwals[0].hariRabu.length,
            );
          }
          return Container();
        },
