...
class JadwalSelasa extends StatelessWidget {
  const JadwalSelasa({super.key});
          ...
          if (state is JadwalDisplayLoaded) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                return CardJadwal(
                  jam: state.jadwals[0].hariSelasa[index].jam,
                  kegiatan: state.jadwals[0].hariSelasa[index].kegiatan,
                  pelaksana: state.jadwals[0].hariSelasa[index].pelaksana,
                  urutan: index + 1,
                );
              },
              ...
              itemCount: state.jadwals[0].hariSelasa.length,
            );
          }
          return Container();
        },
