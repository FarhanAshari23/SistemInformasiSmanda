...
import 'domain/usecases/teacher/get_teacher_for_schedule_usecase.dart';
...
Future<void> initializeDependecies() async {
  ...
  sl.registerSingleton<GetTeacherForScheduleUsecase>(
    GetTeacherForScheduleUsecase(),
  );
  ...
  sl.registerSingleton<GetNewsGlobalUsecase>(
    GetNewsGlobalUsecase(),
  );
  ...
  sl.registerSingleton<AddTeacherCompletionUsecase>(
    AddTeacherCompletionUsecase(),
  );
  sl.registerSingleton<GetAttendanceTeacherUsecase>(
    GetAttendanceTeacherUsecase(),
  );
  sl.registerSingleton<GetAttendanceTeacherCurrentUsecase>(
    GetAttendanceTeacherCurrentUsecase(),
  );
  sl.registerSingleton<GetAttendanceAllTeacherUsecase>(
    GetAttendanceAllTeacherUsecase(),
  );
  sl.registerSingleton<DownloadAttendanceTeachersUsecase>(
    DownloadAttendanceTeachersUsecase(),
  );
  sl.registerSingleton<DownloadAttendanceStudentsUsecase>(
